class Header extends HTMLElement {
    connectedCallback() {
      ...
      <a href="index.html" class="menu-logo">
          <img src="../images/tlj_logo.webp" alt="Tous les Jours logo" class="logo" width="90%" height="90%">
      </a>
      <nav class="menu">
      ...
      <nav class="round-menu">
        ...
        <svg width="23px" height="23px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg">
